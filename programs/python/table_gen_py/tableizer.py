...
def parse_args(sys_args: list) -> argparse.Namespace:
    ...
    parser.add_argument("--mv_matchless", type=str, help="Optional path to folder intended to hold matchless .dfam files produced when no hits are found. When set, the"
                                                         " program will automatically move empty .dfam files to this folder")
...
def _main():
    ...
    matchless_path = args.mv_matchless
    cpu_count = args.cpu
